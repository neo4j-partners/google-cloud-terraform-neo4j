...
To submit an updated listing, run ./makeArchive.sh.  You'll then need to upload those two archives to the neo4j-terraform-marketplace bucket in neo4j-mp-public.  You can do that with the commands:
